...
namespace GameOn.Running
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            SqlCommand cmd = new SqlCommand("[sp_get_all_categories_by_department_id]", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@department_id", SqlDbType.Int).Value = 2;
        ...
        private void loadCategories(DataTable categories)
        {
            ...
            {
                SqlConnection con = new SqlConnection(strConnString);
                SqlCommand cmd = new SqlCommand("[sp_get_top_three_products_by_category_id]", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@category_id", SqlDbType.NVarChar).Value = categories.Rows[i][0].ToString();
                ...
                if (products.Rows.Count > 0)
                {
                    ...
                    categoriesName.NavigateUrl = "~/Running/" + categories.Rows[i][1].ToString();
