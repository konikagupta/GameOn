...
namespace GameOn.Cycling.Cycles
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            cmd.Parameters.Add("@category_id", SqlDbType.Int).Value = 1;
        ...
        private void loadCategories(DataTable categories)
        {
            for (int i = 0; i < categories.Rows.Count; i++)
            {
                ...
                if (products.Rows.Count > 0)
                {
                    ...
                    categoriesName.NavigateUrl = "~/Cycling/Cycles/" + categories.Rows[i][1].ToString().Replace(" ","");
